...
class Topmusic extends Component {
  render() {
    return (
        ...
        <article className="video-top">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/XbM5uUdXe4k" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
        </article>
        <article className="video-top">
